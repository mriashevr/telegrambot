...
words_check_electr_connect = ("электричество", "связь", "электричесвто", "зарядить", "заряжать", "интернет", "интернетом", "инет")
...
words_check_area_work = ("территория", "работа", "работу", "работать", "работы", "выходные", "территории")
